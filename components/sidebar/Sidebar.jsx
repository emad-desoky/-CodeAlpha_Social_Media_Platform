...
const StyledIconButton = styled(IconButton)({
  position: "fixed",
  zIndex: 10,
  top: "calc(50% + 100px)", // Move down 100 pixels from the center
  left: "20px",
...
export default function Sidebar({ setRefetch }) {
  ...
  return (
    <div className="flex">
      ...
      {/* Sidebar */}
      {isSidebarOpen && (
        <div className="sidebar-container flex flex-col bg-gray-900 text-white p-4 shadow-lg w-64">
          {/* Header */}
          ...
          <SettingsDialog
            ...
            handleCloseSettingsDialog={() => setOpenSettingsDialog(false)}
          />
